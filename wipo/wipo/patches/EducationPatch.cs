...
namespace wipo.patches
{
    ...
    public class EducationPatch : EducationCampaignBehavior
    {
        ...
        private EducationCampaignBehavior.EducationStage CreateStage2(Hero child)
        {
            ...
            {
                { DefaultCharacterAttributes.Vigor, new TextObject("{=h7aX2GOw}This child is quite strong, grabbing whatever {?CHILD.GENDER}she{?}he{\\?} likes climbing out of {?CHILD.GENDER}her{?}his{\\?} cradle whenever {?CHILD.GENDER}her{?}his{\\?} caretaker's back is turned.", null) },
                { DefaultCharacterAttributes.Control, new TextObject("{=pQSBdHC7}The child has exceptional coordination for someone {?CHILD.GENDER}her{?}his{\\?} age, and can catch a tossed ball and eat by {?CHILD.GENDER}herself{?}himself{\\?}.", null) },
                { DefaultCharacterAttributes.Endurance, new TextObject("{=xaNpQsjh}The child seems to never tire, running {?CHILD.GENDER}her{?}his{\\?} caretakers ragged, and is rarely cranky.", null) },
                { DefaultCharacterAttributes.Cunning, new TextObject("{=lF41sN5r}You see the glint of mischief on {?CHILD.GENDER}her{?}his{\\?} smiling face. Any sweet left unattended in the kitchen for even a few minutes is quickly stolen.", null) },
                { DefaultCharacterAttributes.Intelligence, new TextObject("{=KVDMVbT1}This child started speaking earlier than most of {?CHILD.GENDER}her{?}his{\\?} peers and can even string together simple sentences.", null) },
                { DefaultCharacterAttributes.Social, new TextObject("{=xXJnW5w0}The child pays close attention to anyone talking to {?CHILD.GENDER}her{?}him{\\?} and sometimes tries to comfort playmates in distress.", null) }
            };
            ...
            {
                { DefaultCharacterAttributes.Vigor, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_toddler_vigor") },
                { DefaultCharacterAttributes.Control, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_toddler_control") },
                { DefaultCharacterAttributes.Endurance, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_toddler_endurance") },
                { DefaultCharacterAttributes.Cunning, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_toddler_cunning") },
                { DefaultCharacterAttributes.Intelligence, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_toddler_intelligence") },
                { DefaultCharacterAttributes.Social, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_toddler_social") }
            };
            ...
            for (int k = 0; k < Attributes.All.Count; k++)
            {
                ...
                for (int l = 0; l < Attributes.All.Count - 1; l++)
                {
                    ...
                    stage_0_page_2.AddOption(new EducationCampaignBehavior.EducationOption(textObject3, textObject4, null, condition, null, new CharacterAttribute[]
                    {
                        attributeOne,
                        attributeTwo
                    }, null, childProperties5, default(EducationCampaignBehavior.EducationCharacterProperties)));
                }
            }
        ...
        private EducationCampaignBehavior.EducationStage CreateStage14(Hero child)
        {
            ...
            {
                new ValueTuple<TextObject, TextObject, SkillObject[]>(new TextObject("{=43zzbI1J}enemy incursions", null), new TextObject("{=AaahFmxv}War was never too far away. On more than one occasion, {CHILD.NAME} spotted foes on the horizon and needed to ride away as quickly as possible.", null), new SkillObject[] { DefaultSkills.Athletics, DefaultSkills.Riding }),
                new ValueTuple<TextObject, TextObject, SkillObject[]>(new TextObject("{=y9RcWMbQ}a local rivalry", null), new TextObject("{=R7A3aPwi}A neighboring noble's brutish son took an interest in persecuting {CHILD.NAME}, but the young {?CHILD.GENDER}woman{?}man{\\?} gave him reason to look elsewhere for his prey.", null), new SkillObject[] { DefaultSkills.OneHanded, DefaultSkills.TwoHanded }),
                new ValueTuple<TextObject, TextObject, SkillObject[]>(new TextObject("{=gHgUwteP}natural disasters", null), new TextObject("{=lDMrl7sd}Your district saw more than its share of floods and fires, and {CHILD.NAME} joined in the effort to stem the destruction and rebuild afterwards.", null), new SkillObject[] { DefaultSkills.Crafting, DefaultSkills.Engineering }),
                new ValueTuple<TextObject, TextObject, SkillObject[]>(new TextObject("{=mzu6exTe}an outbreak of plague", null), new TextObject("{=kAtxHSu9}A great illness swept through your lands. Your child applied what {?CHILD.GENDER}she{?}he{\\?} had read in books on nursing fevers and isolating the sick to minimize deaths on your estate.", null), new SkillObject[] { DefaultSkills.Medicine, DefaultSkills.Steward }),
                new ValueTuple<TextObject, TextObject, SkillObject[]>(new TextObject("{=Jc1YXXjN}an influx of wild beasts", null), new TextObject("{=MX7toYav}{CHILD.NAME} joined a hunting pursuit in pursuit of a pack of wolves who had been ravaging the local livestock. {?CHILD.GENDER}She{?}He{\\?} tracked and took down one of the beasts with an arrow.", null), new SkillObject[] { DefaultSkills.Scouting, DefaultSkills.Bow }),
                new ValueTuple<TextObject, TextObject, SkillObject[]>(new TextObject("{=aiBQo2MR}an outbreak of unrest", null), new TextObject("{=yym5kCG5}After a particularly hard winter your tenants began to murmur about rising up and seizing your granaries. {CHILD.NAME} convinced them to be patient and wait for relief.", null), new SkillObject[] { DefaultSkills.Charm, DefaultSkills.Leadership })
            };
            EducationCampaignBehavior.EducationCharacterProperties[] array = new EducationCampaignBehavior.EducationCharacterProperties[]
            {
                new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_riding_2", "carry_saddle", true),
        ...
        private EducationCampaignBehavior.EducationStage CreateStage16(Hero child)
        {
            ...
            EducationCampaignBehavior.EducationPage[] array = new EducationCampaignBehavior.EducationPage[]
            {
                educationPage2,
                educationPage3,
                educationPage5,
        ...
        private class EducationStage
        {
            ...
            private Equipment GetChildEquipmentForOption(Hero child, string optionKey, List<string> previousOptions)
            {
                ...
                {
                    string arg = previousOptions[0].Split(new char[]
                    {
                        ';'
                    })[2];
