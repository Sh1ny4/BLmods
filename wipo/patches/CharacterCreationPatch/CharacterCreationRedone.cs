...
namespace wipo.patches.CharacterCreationPatch
{
    ...
    public class CharacterCreationRedone : SandboxCharacterCreationContent
    {
        ...
        protected void AddYouthMenuPatch(CharacterCreation characterCreation)
        {
            ...
            //Empire
            characterCreationCategory.AddCategoryOption(new TextObject("{=!CCR_Start_Choice_Ecommander}a small unit commander", null), new MBList<SkillObject> { DefaultSkills.Steward, DefaultSkills.Tactics,DefaultSkills.Leadership }, DefaultCharacterAttributes.Intelligence, 1, 30, 2, new CharacterCreationOnCondition(EmpireRetainerOnCondition), new CharacterCreationOnSelect(YouthEmpireCommanderOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!CCR_Start_Choice_Eengineer}an engineer's student", null), new MBList<SkillObject> { DefaultSkills.Engineering, DefaultSkills.Steward, DefaultSkills.Crafting }, DefaultCharacterAttributes.Intelligence, 1, 30, 2, new CharacterCreationOnCondition(EmpireOnCondition), new CharacterCreationOnSelect(YouthEmpireEngineerOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCavalryOnApply), new TextObject("{=!}", null), null, 0, 0, 0, 0, 0);
