...
namespace wipo.patches.CharacterCreationPatch
{
    ...
    public class CharacterCreationRedone : SandboxCharacterCreationContent
    {
        ...
        protected void AddParentsMenuPatch(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory4.AddCategoryOption(new TextObject("{=!}Emirs", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, 1, 30, 2, null, new CharacterCreationOnSelect(AseraiTribesmanOnConsequence), new CharacterCreationApplyFinalEffects(this.AseraiTribesmanOnApply), new TextObject("{=!}Your father was an Emir. The land he ruled, while far from the wealthiest, brought him enough to afford everything a smaller nobility could want.", null), null, 0, 150, 3000, 0, 0);
            ...
            characterCreationCategory5.AddCategoryOption(new TextObject("{=!}Chieftain", null), new MBList<SkillObject> { DefaultSkills.Charm, DefaultSkills.Bow }, DefaultCharacterAttributes.Control, 1, 30, 2, null, new CharacterCreationOnSelect(BattaniaChieftainsHearthguardOnConsequence), new CharacterCreationApplyFinalEffects(this.BattaniaChieftainsHearthguardOnApply), new TextObject("{=!}Your father was a Chieftain, managing a small village in day to day affairs but also leading its volunteers to war.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}Landlords", null), new MBList<SkillObject> { DefaultSkills.Leadership, DefaultSkills.Steward }, DefaultCharacterAttributes.Social, 1, 30, 2, null, new CharacterCreationOnSelect(EmpireLandlordsRetainerOnConsequence), new CharacterCreationApplyFinalEffects(this.EmpireLandlordsRetainerOnApply), new TextObject("{=!}Your father was a small time aristocrat of the empire. Far from being a fighter, his skills in organization were earned when he worked as a general's aide.", null), null, 0, 0, 0, 0, 0);
            ...
            characterCreationCategory6.AddCategoryOption(new TextObject("{=!}Noyans", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Bow }, DefaultCharacterAttributes.Endurance, 1, 30, 2, null, new CharacterCreationOnSelect(KhuzaitNoyansKinsmanOnConsequence), new CharacterCreationApplyFinalEffects(this.KhuzaitNoyansKinsmanOnApply), new TextObject("{=!}Your father was the Noyan of a small nomadic tribe before joining the khanate, at which point he was allowed to join the Khan's guard .", null), null, 0, 150, 3000, 0, 0);
            ...
            characterCreationCategory3.AddCategoryOption(new TextObject("{=!}Boyars", null), new MBList<SkillObject> { DefaultSkills.Athletics, DefaultSkills.TwoHanded }, DefaultCharacterAttributes.Vigor, 1, 30, 2, null, new CharacterCreationOnSelect(SturgiaBoyarsCompanionOnConsequence), new CharacterCreationApplyFinalEffects(this.SturgiaBoyarsCompanionOnApply), new TextObject("{=!}Your father was a boyar that led his druzhina in countless raids against calradian villages.", null), null, 0, 150, 3000, 0, 0);
            ...
            characterCreationCategory2.AddCategoryOption(new TextObject("{=!}Barons", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm }, DefaultCharacterAttributes.Vigor, 1, 30, 2, null, new CharacterCreationOnSelect(VlandiaBaronsRetainerOnConsequence), new CharacterCreationApplyFinalEffects(this.VlandiaBaronsRetainerOnApply), new TextObject("{=!}Your father was a Baron. When he didn't watch after his estate, he joined the Royal army as a knight under his own banner.", null), null, 0, 150, 3000, 0, 0);
        ...
        protected void AddEducationMenuPatch(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}Training to become a Faris.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(AseraiRetainerOnCondition), new CharacterCreationOnSelect(UrbanAdolescenceTutorOnConsequence), new CharacterCreationApplyFinalEffects(SandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply), new TextObject("{=hXl25avg}Your family arranged for a private tutor and you took full advantage, reading voraciously on history, mathematics, and philosophy and discussing what you read with your tutor and classmates.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}Training to join a Fianna.", null), new MBList<SkillObject> { DefaultSkills.TwoHanded, DefaultSkills.Bow, DefaultSkills.Athletics }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(BattaniaRetainerOnCondition), new CharacterCreationOnSelect(UrbanAdolescenceTutorOnConsequence), new CharacterCreationApplyFinalEffects(SandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply), new TextObject("{=hXl25avg}Your family arranged for a private tutor and you took full advantage, reading voraciously on history, mathematics, and philosophy and discussing what you read with your tutor and classmates.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}Learning how to tend your land.", null), new MBList<SkillObject> { DefaultSkills.Steward, DefaultSkills.Leadership, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, 1, 20, 2, new CharacterCreationOnCondition(EmpireRetainerOnCondition), new CharacterCreationOnSelect(UrbanAdolescenceTutorOnConsequence), new CharacterCreationApplyFinalEffects(SandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply), new TextObject("{=hXl25avg}Your family arranged for a private tutor and you took full advantage, reading voraciously on history, mathematics, and philosophy and discussing what you read with your tutor and classmates.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}Training to join the Khan's guard.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Bow, DefaultSkills.Polearm }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(KhuzaitRetainerOnCondition), new CharacterCreationOnSelect(UrbanAdolescenceTutorOnConsequence), new CharacterCreationApplyFinalEffects(SandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply), new TextObject("{=hXl25avg}Your family arranged for a private tutor and you took full advantage, reading voraciously on history, mathematics, and philosophy and discussing what you read with your tutor and classmates.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}Training to join a Druzhina.", null), new MBList<SkillObject> { DefaultSkills.Athletics, DefaultSkills.TwoHanded, DefaultSkills.Throwing }, DefaultCharacterAttributes.Vigor, 1, 20, 2, new CharacterCreationOnCondition(SturgiaRetainerOnCondition), new CharacterCreationOnSelect(UrbanAdolescenceTutorOnConsequence), new CharacterCreationApplyFinalEffects(SandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply), new TextObject("{=hXl25avg}Your family arranged for a private tutor and you took full advantage, reading voraciously on history, mathematics, and philosophy and discussing what you read with your tutor and classmates.", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}Training to become a Knight .", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.TwoHanded }, DefaultCharacterAttributes.Vigor, 1, 20, 2, new CharacterCreationOnCondition(VlandiaRetainerOnCondition), new CharacterCreationOnSelect(UrbanAdolescenceTutorOnConsequence), new CharacterCreationApplyFinalEffects(SandboxCharacterCreationContent.UrbanAdolescenceDockerOnApply), new TextObject("{=hXl25avg}Your family arranged for a private tutor and you took full advantage, reading voraciously on history, mathematics, and philosophy and discussing what you read with your tutor and classmates.", null), null, 0, 0, 0, 0, 0);
        ...
        {
            return this._familyOccupationType == SandboxCharacterCreationContent.OccupationTypes.Retainer  && base.GetSelectedCulture().StringId == "aserai";
        }
        protected bool BattaniaRetainerOnCondition()
        {
            return this._familyOccupationType == SandboxCharacterCreationContent.OccupationTypes.Retainer && base.GetSelectedCulture().StringId == "battania";
        }
        protected bool EmpireRetainerOnCondition()
        {
            return this._familyOccupationType == SandboxCharacterCreationContent.OccupationTypes.Retainer && base.GetSelectedCulture().StringId == "empire";
        }
        protected bool KhuzaitRetainerOnCondition()
        {
            return this._familyOccupationType == SandboxCharacterCreationContent.OccupationTypes.Retainer && base.GetSelectedCulture().StringId == "khuzait";
        }
        protected bool SturgiaRetainerOnCondition()
        {
            return this._familyOccupationType == SandboxCharacterCreationContent.OccupationTypes.Retainer && base.GetSelectedCulture().StringId == "sturgia";
        }
        protected bool VlandiaRetainerOnCondition()
        {
            return this._familyOccupationType == SandboxCharacterCreationContent.OccupationTypes.Retainer && base.GetSelectedCulture().StringId == "vlandia";
        }
        ...
        protected void AddYouthMenuPatch(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}became a Faris.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(AseraiNobleTroopOnCondition), new CharacterCreationOnSelect(AseraiNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}became a Faris.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(AseraiNobleTroopOnCondition), new CharacterCreationOnSelect(AseraiNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new TextObject("{=!}swore an Oath to a Chieftain.", null), new MBList<SkillObject> { DefaultSkills.TwoHanded, DefaultSkills.Bow, DefaultSkills.Athletics }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(BattaniaNobleTroopOnCondition), new CharacterCreationOnSelect(BattaniaNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}became a Faris.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(AseraiNobleTroopOnCondition), new CharacterCreationOnSelect(AseraiNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new TextObject("{=!}entered Aristocracy.", null), new MBList<SkillObject> { DefaultSkills.Steward, DefaultSkills.Leadership, DefaultSkills.Charm }, DefaultCharacterAttributes.Social, 1, 20, 2, new CharacterCreationOnCondition(EmpireNobleTroopOnCondition), new CharacterCreationOnSelect(EmpireNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}became a Faris.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(AseraiNobleTroopOnCondition), new CharacterCreationOnSelect(AseraiNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new TextObject("{=!}joined the Khishig.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Bow, DefaultSkills.Polearm }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(KhuzaitNobleTroopOnCondition), new CharacterCreationOnSelect(KhuzaitNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}became a Faris.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(AseraiNobleTroopOnCondition), new CharacterCreationOnSelect(AseraiNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new TextObject("{=!}joined a Druzhina.", null), new MBList<SkillObject> { DefaultSkills.Athletics, DefaultSkills.TwoHanded, DefaultSkills.Throwing }, DefaultCharacterAttributes.Vigor, 1, 20, 2, new CharacterCreationOnCondition(SturgiaNobleTroopOnCondition), new CharacterCreationOnSelect(SturgiaNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}became a Faris.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(AseraiNobleTroopOnCondition), new CharacterCreationOnSelect(AseraiNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);

            characterCreationCategory.AddCategoryOption(new TextObject("{=!}became a Knight.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.TwoHanded }, DefaultCharacterAttributes.Vigor, 1, 20, 2, new CharacterCreationOnCondition(VlandiaNobleTroopOnCondition), new CharacterCreationOnSelect(VlandiaNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}became a Faris.", null), new MBList<SkillObject> { DefaultSkills.Riding, DefaultSkills.Polearm, DefaultSkills.OneHanded }, DefaultCharacterAttributes.Endurance, 1, 20, 2, new CharacterCreationOnCondition(AseraiNobleTroopOnCondition), new CharacterCreationOnSelect(AseraiNobleTroopOnConsequence), new CharacterCreationApplyFinalEffects(this.YouthCommanderOnApply), new TextObject("{=!}PLACEHOLDER", null), null, 0, 0, 0, 0, 0);
        ...
        protected bool AseraiNobleTroopOnCondition()
        {
        ...
        protected void AseraiNobleTroopOnConsequence(CharacterCreation characterCreation)
        {
        ...
        protected bool BattaniaNobleTroopOnCondition()
        {
        ...
        protected void BattaniaNobleTroopOnConsequence(CharacterCreation characterCreation)
        {
            base.SelectedTitleType = 10;
            this.RefreshPlayerAppearance(characterCreation);
            characterCreation.ChangeCharsAnimation(new List<string>
        ...
        protected bool EmpireNobleTroopOnCondition()
        {
        ...
        protected void EmpireNobleTroopOnConsequence(CharacterCreation characterCreation)
        {
            base.SelectedTitleType = 10;
            this.RefreshPlayerAppearance(characterCreation);
            characterCreation.ChangeCharsAnimation(new List<string>
        ...
        protected bool KhuzaitNobleTroopOnCondition()
        {
        ...
        protected void KhuzaitNobleTroopOnConsequence(CharacterCreation characterCreation)
        {
            base.SelectedTitleType = 10;
            this.RefreshPlayerAppearance(characterCreation);
            characterCreation.ChangeCharsAnimation(new List<string>
        ...
        protected bool SturgiaNobleTroopOnCondition()
        {
        ...
        protected void SturgiaNobleTroopOnConsequence(CharacterCreation characterCreation)
        {
            base.SelectedTitleType = 10;
            this.RefreshPlayerAppearance(characterCreation);
            characterCreation.ChangeCharsAnimation(new List<string>
        ...
        protected bool VlandiaNobleTroopOnCondition()
        {
        ...
        protected void VlandiaNobleTroopOnConsequence(CharacterCreation characterCreation)
        {
            base.SelectedTitleType = 10;
            this.RefreshPlayerAppearance(characterCreation);
            characterCreation.ChangeCharsAnimation(new List<string>
