...
namespace wipo.patches.TownsBehaviours
{
    ...
    internal class test
    {
        ...
        static bool Prefix(ref DefaultBuildingTypes __instance)
        {
            ...
            _buildingDailyInfluence = Create("project_influence");
            _buildingDailyXP = Create("project_xp");
            InitializeAll(); 
            return false;
        }
        ...
        static void InitializeAll()
        {
            ...
            _buildingDailyInfluence.Initialize(new TextObject("Increase Your Influence", null), new TextObject("Increases your influence", null), new int[3], BuildingLocation.Daily, new Tuple<BuildingEffectEnum, float, float, float>[] { new Tuple<BuildingEffectEnum, float, float, float>(BuildingEffectEnum.Influence, 5f, 5, 5) }, 0);
            _buildingDailyXP.Initialize(new TextObject("Train Garrison", null), new TextObject("Schedules drills for the garrison, increasing their experience", null), new int[3], BuildingLocation.Daily, new Tuple<BuildingEffectEnum, float, float, float>[] { new Tuple<BuildingEffectEnum, float, float, float>(BuildingEffectEnum.Experience, 50f, 50f, 50f) }, 0);
        }
        ...
        static BuildingType _buildingDailyXP;
        static BuildingType _buildingDailyInfluence;
    }
}
