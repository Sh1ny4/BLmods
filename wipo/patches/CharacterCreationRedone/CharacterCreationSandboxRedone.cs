...
namespace wipo.patches.CharacterCreationPatch
{
    ...
    public class CharacterCreationSandboxRedone : SandboxCharacterCreationContent
    {
        ...
        public void AddAgeSelectionMenuPatch(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("{=!}16 !only if playing with the passage of time", null), new MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(StartingAgeMinorOnConsequence), new CharacterCreationApplyFinalEffects(StartingAgeMinorOnApply), new TextObject("{=CCR_Age_16_desc}Some might say you are too young, but your eagerness more than makes up for your lack of experience.", null), null, 0, 0, 0, 0, 0);
